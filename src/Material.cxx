...
template <>
MeshLib_EXPORT std::shared_ptr<Texture<unsigned char>> Material::GetTextureData(std::string const& pName) const
{
...
template <>
MeshLib_EXPORT std::shared_ptr<Texture<unsigned short>> Material::GetTextureData(std::string const& pName) const
{
...
template <>
MeshLib_EXPORT std::shared_ptr<Texture<float>> Material::GetTextureData(std::string const& pName) const
{
...
template <>
MeshLib_EXPORT bool Material::HasTextureData<unsigned char>(std::string const& pName) const
{
  ByteTextureMap::const_iterator it = m_ucharTextures.find(pName);
...
template <>
MeshLib_EXPORT bool Material::HasTextureData<float>(std::string const& pName) const
{
  return m_floatTextures.find(pName) != m_floatTextures.end();
}

template <>
MeshLib_EXPORT bool Material::HasTextureData<unsigned short>(std::string const& pName) const
{
